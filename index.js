...
client.on('message', msg => {
  if (msg.content === '!assistance') {
    msg.reply('Welcome to SpigsBot - a Bot created by Shrijith Vakula.    Useful Commands for Images: to start an image search, type: !<your search query here>. For Music Control, There are Multiple Commands: the !help command should list them all.');
  }
});
